  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">أضف طالب جديد لمركزك</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-base font-semibold text-gray-900">بيانات ولي الأمر (اختياري)</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="parent_name" className="mb-1 block text-sm font-medium text-gray-700">
                اسم ولي الأمر
              </label>
              <input
                id="parent_name"
            ...
            <div>
              <label htmlFor="parent_phone" className="mb-1 block text-sm font-medium text-gray-700">
                هاتف ولي الأمر
              </label>
              <input
                id="parent_phone"
