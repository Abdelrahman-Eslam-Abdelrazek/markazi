...
export function CourseStatusToggle({ courseId, currentStatus }: { courseId: string; currentStatus: string }) {
  ...
  function handleToggle() {
    startTransition(async () => {
      const result = await toggleCourseStatus(courseId, nextStatus);
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        ...
        {isPending ? "..." : confirming ? "تأكيد الحذف" : "حذف"}
      </button>
    </div>
  );
}
